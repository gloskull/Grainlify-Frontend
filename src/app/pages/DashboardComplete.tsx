...
export function DashboardComplete() {
  ...
  return (
    ...
    >
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-4 left-4 bottom-4 z-50 transition-all duration-300 ${isSidebarCollapsed ? 'w-[93px]' : 'w-72'}`}
      >
        ...
        >
          <div className="flex flex-col h-full px-0 py-[40px]">
            {/* Logo/Avatar */}
            <div
              className={`flex items-center mb-6 transition-all ${isSidebarCollapsed ? 'px-[18px] justify-center' : 'px-6 justify-start'}`}
            >
              {isSidebarCollapsed ? (
      ...
      {/* Main Content */}
      <main
        className={`mr-4 my-4 relative z-10 transition-all duration-300 ${isSidebarCollapsed ? 'ml-[117px]' : 'ml-80'}`}
      >
        <div className="max-w-[1400px] mx-auto">
          {/* Top Bar */}
          <div
            className={`backdrop-blur-[40px] rounded-[24px] border shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-6 mb-6 transition-colors overflow-visible ${
              theme === 'dark'
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3 relative z-50">
                ...
                <button
                  className={`relative p-3 rounded-[14px] backdrop-blur-[30px] border transition-all shadow-[0_4px_12px_rgba(0,0,0,0.04)] ${
                    theme === 'dark'
                      ? 'bg-white/[0.08] border-white/15 text-[#d4af37] hover:bg-white/[0.12]'
                      : 'bg-white/[0.15] border-white/25 text-[#7a6b5a] hover:bg-white/[0.2]'
                  }`}
...
function DiscoverPage() {
  ...
  const projects = [
    {
      ...
      issues: 650,
      description:
        'A modern React ecosystem for building user interfaces with enhanced UI/UX modules.',
  ...
  return (
    <div className="space-y-6">
      {/* Hero Section */}
      <div
        className={`backdrop-blur-[40px] rounded-[28px] border shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-12 text-center transition-colors ${
          theme === 'dark'
      ...
      >
        <h1
          className={`text-[36px] font-bold mb-2 transition-colors ${
        ...
        <p
          className={`text-[16px] mb-8 max-w-2xl mx-auto transition-colors ${
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            >
              Learn about the ecosystem onboarding quest and track your progress directly on our
              onboarding Quest
            </p>
          ...
          >
            <div className="flex items-start justify-between mb-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3
                    className={`text-[22px] font-bold mb-2 transition-colors ${
                      theme === 'dark' ? 'text-[#f5f5f5]' : 'text-[#2d2820]'
                    }`}
                  >
                    {event.title}
            ...
            <div className="grid grid-cols-4 gap-8 mb-6">
              ...
              <div>
                ...
                <div
                  className={`text-[28px] font-bold flex items-center space-x-2 transition-colors ${
                    theme === 'dark' ? 'text-[#f5f5f5]' : 'text-[#2d2820]'
                  }`}
                >
            ...
            <div className="flex items-center justify-between pt-6 border-t border-white/10">
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <div
                    className={`text-[12px] mb-1 transition-colors ${
                      theme === 'dark' ? 'text-[#d4d4d4]' : 'text-[#7a6b5a]'
                    }`}
                  >
                    Start date
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {pastEvents.map((event) => (
          ...
          >
            ...
            <div
              className={`flex items-center justify-between text-[12px] pt-4 border-t border-white/10 transition-colors ${
                theme === 'dark' ? 'text-[#d4d4d4]' : 'text-[#7a6b5a]'
              }`}
            >
              <div>
                <div className="mb-0.5">{event.startDate}</div>
                <div className={theme === 'dark' ? 'text-[#b8a898]' : 'text-[#8b7a6a]'}>
                  {event.startTime}
                </div>
              </div>
...
function EcosystemsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header Section */}
      <div
        className={`backdrop-blur-[40px] bg-gradient-to-br rounded-[28px] border shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-10 transition-colors ${
          theme === 'dark'
      ...
      >
        <div className="flex items-start justify-between">
          <div className="flex-1">
            <h1
              className={`text-[36px] font-bold mb-3 transition-colors ${
                theme === 'dark' ? 'text-[#f5f5f5]' : 'text-[#2d2820]'
              }`}
            >
              Explore Ecosystems
      ...
      {/* Search Bar Section */}
      <div
        className={`backdrop-blur-[40px] rounded-[20px] border shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-5 transition-colors ${
          theme === 'dark' ? 'bg-white/[0.08] border-white/10' : 'bg-white/[0.12] border-white/20'
        }`}
      >
        <div className="relative">
          <Search
            className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 z-10 pointer-events-none transition-colors ${
          ...
          {filteredEcosystems.map((ecosystem) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-5">
                  <div
                    className={`w-14 h-14 rounded-[14px] bg-gradient-to-br ${ecosystem.color} flex items-center justify-center shadow-lg border border-white/20`}
                  >
                ...
                <div className="flex items-center gap-6 mb-4">
                  <div>
                    <div
                      className={`text-[11px] mb-0.5 transition-colors ${
                        theme === 'dark' ? 'text-[#d4d4d4]' : 'text-[#7a6b5a]'
                      }`}
                    >
                      Projects
                ...
                {/* Description */}
                <p
                  className={`text-[13px] mb-5 leading-relaxed transition-colors ${
                    theme === 'dark' ? 'text-[#d4d4d4]' : 'text-[#7a6b5a]'
                  }`}
                >
      ...
      <div
        className={`backdrop-blur-[40px] bg-gradient-to-br rounded-[24px] border shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-10 transition-all overflow-hidden relative ${
          theme === 'dark'
            ? 'from-white/[0.08] to-white/[0.04] border-white/10'
            : 'from-white/[0.15] to-white/[0.08] border-white/20'
        }`}
      >
        ...
        <div className="relative z-10">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h3
              className={`text-[28px] font-bold mb-4 transition-colors ${
                theme === 'dark' ? 'text-[#f5f5f5]' : 'text-[#2d2820]'
              }`}
            >
            ...
            <p
              className={`text-[16px] mb-6 leading-relaxed transition-colors ${
                theme === 'dark' ? 'text-[#d4d4d4]' : 'text-[#7a6b5a]'
              }`}
            >
      ...
      {showAddModal && (
        ...
        >
          ...
          >
            <h3
              className={`text-[24px] font-bold mb-6 transition-colors ${
                theme === 'dark' ? 'text-[#f5f5f5]' : 'text-[#2d2820]'
              }`}
            >
              Add New Ecosystem
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setRequestData({ ...requestData, userEmail: e.target.value })
                      }
                      className={`w-full px-4 py-3 rounded-[14px] backdrop-blur-[30px] border focus:outline-none transition-all text-[14px] ${
                        theme === 'dark'
                          ? 'bg-white/[0.08] border-white/15 text-[#f5f5f5] placeholder-[#d4d4d4] focus:bg-white/[0.12] focus:border-[#c9983a]/30'
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setRequestData({ ...requestData, ecosystemName: e.target.value })
                    }
                    className={`w-full px-4 py-3 rounded-[14px] backdrop-blur-[30px] border focus:outline-none transition-all text-[14px] ${
                      theme === 'dark'
                        ? 'bg-white/[0.08] border-white/15 text-[#f5f5f5] placeholder-[#d4d4d4] focus:bg-white/[0.12] focus:border-[#c9983a]/30'
                ...
                <div>
                  ...
                  >
                    Why do you want this ecosystem added? *
                  </label>
                  <textarea
                    rows={4}
                    required
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setRequestData({ ...requestData, additionalInfo: e.target.value })
                    }
                    className={`w-full px-4 py-3 rounded-[14px] backdrop-blur-[30px] border focus:outline-none transition-all text-[14px] resize-none ${
                      theme === 'dark'
                        ? 'bg-white/[0.08] border-white/15 text-[#f5f5f5] placeholder-[#d4d4d4] focus:bg-white/[0.12] focus:border-[#c9983a]/30'
